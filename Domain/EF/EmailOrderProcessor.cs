    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        public void ProcessOrder(Cart cart, ShippingDetails shippingDetails)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                MailAddress from = new MailAddress("lakshmi.sergey@gmail.com", "Avto_Zapchast");
                // кому отправляем
                MailAddress to = new MailAddress("azaza.67@mail.ru");
                ...
                body.AppendFormat("\nОбщая стоимость: {0} Тг", cart.ComputeTotalValue())
                    ...
                    .AppendLine("-----------------")
                    .AppendFormat("Доставка: {0}", shippingDetails.GiftWrap ? "Да" : "Нет");
